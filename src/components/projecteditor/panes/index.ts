...
const mapDispatchToProps = (dispatch: Dispatch) => {
    return {
        ...
        onUnsavedChange(fileId: string, hasUnsavedChanges: boolean, unSavedCode: string) {
            dispatch(panesActions.setUnsavedChanges(fileId, hasUnsavedChanges, unSavedCode));
        },
